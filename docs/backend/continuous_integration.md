...
## Setting up Bot Platform with Drone.io Continuous Integration
...
5. Select ` bot-platform-web ` for your repo
...
psql -c "CREATE DATABASE bot_platform;" -U postgres
...
1. Click ( "Deployment" )[https://drone.io/github.com/aniketmaithani/bot-platform-web/admin/deployments#/]
...
4. Add `https://git.heroku.com:bot_platform-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - bot_platform-qa for branch qa
    - bot_platform-prod for branch prod
